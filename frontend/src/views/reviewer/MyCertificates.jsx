...
/**
 * MyCertificates Component (Reviewer)
 * Displays list of certificates issued to the reviewer
...
const MyCertificates = () => {
  ...
  const getCertificateTypeLabel = (type) => {
    return type === 'subscription' ? 'Reviewer Joining Certificate' : 'Event Participation'
  }
                  ...
                  <div style={{ flex: 1, minWidth: '250px' }}>
                    <div style={{ 
                      ...
                      <div style={{
                        ...
                        <svg 
                          style={{ width: '24px', height: '24px', color: '#1a5490' }} 
                          fill="none" 
                          stroke="currentColor" 
                          viewBox="0 0 24 24"
                        >
                      ...
                      <div>
                        <h3 style={{ 
                          ...
                          {cert.event_name || 'Reviewer Joining Certificate'}
                        </h3>
                        <span style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center' }}>
                    <button
                      ...
                      style={{
                        ...
                        backgroundColor: downloading === cert.certificate_id ? '#D1D5DB' : '#1a5490',
                        color: 'white',
                        border: 'none',
                        borderRadius: '8px',
                        fontSize: '0.875rem',
                      ...
                      onMouseEnter={(e) => {
                        if (downloading !== cert.certificate_id) {
                          e.target.style.backgroundColor = '#0f3d6e'
                        }
                      }}
                      onMouseLeave={(e) => {
                        if (downloading !== cert.certificate_id) {
